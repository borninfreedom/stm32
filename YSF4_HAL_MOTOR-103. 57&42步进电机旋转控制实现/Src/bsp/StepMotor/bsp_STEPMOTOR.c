...
{  
  ...
  __HAL_TIM_SET_COMPARE(&htimx_STEPMOTOR,STEPMOTOR_NO1_TIM_CHANNEL_x | STEPMOTOR_NO2_TIM_CHANNEL_x,tim_count+srd.step_delay); // 设置定时器比较值
  TIM_CCxChannelCmd(STEPMOTOR_TIMx, STEPMOTOR_NO1_TIM_CHANNEL_x | STEPMOTOR_NO2_TIM_CHANNEL_x, TIM_CCx_ENABLE);// 使能定时器通道 
  STEPMOTOR_OUTPUT1_ENABLE();
	STEPMOTOR_OUTPUT2_ENABLE();
}
